  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(
        ...
        horizontal: Sizing.getProportionateScreenWidth(30),
      ),
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.receipt, color: kPrimaryColor, size: Sizing.getProportionateScreenWidth(20),),
                ),
                Spacer(),
              ...
              children: [
                Text.rich(
                  TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: "\$ " + sumOfProducts(demoCarts).toString(),
                ...
                SizedBox(
                  width: Sizing.getProportionateScreenWidth(190),
                  child: DefaultButton(
                    text: "Check Out",
                    press: () {},
                  ),
...
double sumOfProducts(List<Cart> carts){
  double sum = 0;
  carts.forEach((element) {sum += element.product.price;});
  return sum;
}